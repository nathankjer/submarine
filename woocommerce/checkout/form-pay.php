	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'submarine' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'submarine' ); ?></th>
			</tr>
		</thead>
		<tbody>
